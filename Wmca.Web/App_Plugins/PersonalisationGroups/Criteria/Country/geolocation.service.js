    ...
    .factory("geoLocationService", function ($http) {
        ...
        var service = {
            getContinentList: function () {
                var url = "/App_Plugins/PersonalisationGroups/GeoLocation/GetContinents";
                return $http.get(url, { cache: true });
            },

            getCountryList: function (withRegionsOnly) {
                var url = "/App_Plugins/PersonalisationGroups/GeoLocation/GetCountries?withRegionsOnly=" + withRegionsOnly;
                return $http.get(url, { cache: true });
            },

            getRegionList: function (countryCode) {
                var url = "/App_Plugins/PersonalisationGroups/GeoLocation/GetRegions?countryCode=" + countryCode;
                return $http.get(url, { cache: true });
            },
